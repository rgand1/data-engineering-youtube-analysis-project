...
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "data-dngineering-youtube-raw", table_name = "raw_video", transformation_ctx = "datasource0", push_down_predicate = predicate_pushdown)
...
datasink4 = glueContext.write_dynamic_frame.from_options(frame = df_final_output, connection_type = "s3", connection_options = {"path": "s3://data-dngineering-cleansed-youtube-raw-eu-north-1-dev/raw_video/", "partitionKeys": ["region"]}, format = "parquet", transformation_ctx = "datasink4")
